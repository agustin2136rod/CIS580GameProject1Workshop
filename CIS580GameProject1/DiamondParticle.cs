...
{
    /// <summary>
    /// Class to represent a diamond particle trailing the slime ghost
    /// </summary>
    public class DiamondParticle
    {

        //All properties for the diamond particles
        ...
        public DiamondParticle(Texture2D texture, Vector2 position, Vector2 velocity, float angle, float angleVelocity, Color color, float size, int time)
        {
            Texture = texture;
            Position = position;
            Velocity = velocity;
