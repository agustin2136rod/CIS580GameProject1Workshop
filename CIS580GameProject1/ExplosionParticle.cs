...
{
    /// <summary>
    /// Class to represent a particle when a collision occurs
    /// </summary>
    public class ExplosionParticle
    {
        ...
        public ExplosionParticle(Texture2D texture, Vector2 position, Vector2 velocity, float angle, float angleVelocity, Color color, float size, int time)
        {
            Texture = texture;
            Position = position;
            Velocity = velocity;
